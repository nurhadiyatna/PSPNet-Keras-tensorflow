...
for i in range(0,int(split)):
    ...
    history = autoencoder.fit(train, train_label, batch_size=batch_size, epochs=nb_epoch,callbacks = [csv_logger],
    ...
    autoencoder.save_weights('Training_'+training_is+'_'+str(train_sample)+str(i)+'_splits.h5')
