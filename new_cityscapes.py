...
def prep_train(j,k,train_txt):
    train_data = np.zeros((int(split), im_dimension, im_height, im_width), dtype="uint8")
...
#     # history = autoencoder.fit(train, train_label, batch_size=batch_size, nb_epoch=nb_epoch,
